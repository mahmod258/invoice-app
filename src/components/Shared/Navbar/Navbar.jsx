...
function Navbar() {
  ...
  const [bgMode, setBgMode] = useState("dark mode");
  useEffect(() => {
    if (bgMode === "dark mode") {
      setSvgPath(
        <path
      ...
      <div>
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="26">
          <path
            fill="#FFF"
            fill-rule="evenodd"
            d="M20.513 0C24.965 2.309 28 6.91 28 12.21 28 19.826 21.732 26 14 26S0 19.826 0 12.21C0 6.91 3.035 2.309 7.487 0L14 13.9z"
          />
        </svg>
      </div>
      <div>
        <svg
          ...
          onClick={() => {
            ...
            if (bgMode === "dark mode") {
              root.style.setProperty("--dark1", "#F2F2F2");
              root.style.setProperty("--dark4", "#F8F8FB");
              root.style.setProperty("--dark5", "#373B53");
              root.style.setProperty("--dark3", "#F9FAFE");
              root.style.setProperty("--dark2", "white");
              root.style.setProperty("--text", "black");
              root.style.setProperty("--text2", "white");
              setBgMode("light mode");
            } else {
              root.style.setProperty("--dark1", "#151826");
              root.style.setProperty("--dark2", "#1e2139");
              root.style.setProperty("--dark3", "#252945");
              root.style.setProperty("--dark4", "#373b53");
              root.style.setProperty("--dark5", "#0c0e16");
